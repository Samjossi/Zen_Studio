...
> **状态**：已实施（2026-08 归档时核实：media_path 载荷与 MediaReadCard 已落地于 llm/providers/acp.py、llm/base.py、gui/panels/chat/cards.py，代码注释含「0158 计划」标记）
...
> **优先级**：中（可读性增强，不阻塞功能）
> **前序**：`文档/修改记录/2026-0806-1712_工具调用卡片渲染修复计划.md`（T1 入参迟到回填、T4 BodyHtml 出参图片、T5 工具名分派表，本计划直接复用三项机制）
