...
> **优先级**：中
> **上游文档**：`work options/2026-0725-2027_Markdown渲染预览功能选型.md`（选型已定夺，决策见 §8 决策记录）；架构先例：`work plans/2026-0729-1102_图片文件预览功能实施计划.md`、`work plans/2026-0729-1120_音视频播放功能实施计划.md`
...
*撰写于 2026-07-29 11:55 (UTC+8) | 依据：`work options/2026-0725-2027_Markdown渲染预览功能选型.md`（决策已定夺）+ 2026-07-29 审阅增补 Typora 打开功能 | 合规基线：`2026-0729-1028_theia实质代码审计与协议补全建议.md`*
